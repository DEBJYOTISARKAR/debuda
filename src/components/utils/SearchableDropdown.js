...
export default class SearchableDropDown extends Component {
  ...
  fetchKeywords = async query => {
    ...
    // const url = `http://mobiletest.gofba.com/api/LoginJson/GetKeywords?keyword=${query}`;
    // console.log(url);
    // const response = await fetch(url, {method: 'GET'});
    // const res = await response.json();
    // const Keywords = res.map(function (obj) {
    //   return {
    //     id: obj.SubCategoryDetailsID,
    //     name: obj.Keyword,
    //   };
  ...
  searchedItems = async searchedText => {
    ...
    // var ac = await this.fetchKeywords(searchedText);
    // console.log(ac);
